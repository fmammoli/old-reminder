  ...
  return (
    ...
    >
      <div className="relative isolate overflow-hidden bg-[#EEF0F4] md:rounded-xl ">
        <nav className="flex justify-between items-center py-8 px-4 dark:transition-colors dark:delay-300 dark:text-white">
          <a href="">
            <svg
              className="w-8 h-8 "
        ...
        <div className="max-w-md mx-auto font-sans font-light py-12 text-sm sm:px-12 dark:transition-colors dark:delay-300 dark:text-white">
          ...
          <p className="py-4 leading-relaxed">
            ...
            diarreia do viajante e outras infecções intestinais.[1] Pode também
            ser usada no tratamento de várias infecções sexualmente
            transmissíveis, incluindo clamídia e gonorreia.[1] Em associação com
            outros fármacos, pode também ser usada no tratamento de malária.[1]
            Pode ser administrada por via oral ou intravenosa ou endovenosa.[1]
          </p>
          <p>
            Os efeitos adversos mais comuns são náuseas, vómitos, diarreia e
            indisposição no estômago.[1] Entre outros possíveis efeitos
            adversos, menos comuns, estão reações alérgicas, como anafilaxia, QT
            longo ou um tipo de diarreia causado por Clostridium difficile.[1] O
            uso durante a gravidez não está indicado exceto em caso de
            necessidade expressa.[2][1] A sua segurança durante a amamentação
            não está firmemente estabelecida, mas é provavelmente segura.[3] A
            azitromicina é um antibiótico do grupo dos macrólidos.[1] O
            mecanismo de ação envolve a diminuição da produção de proteínas,
            impedindo o crescimento das bactérias.[1]
          </p>
        </div>
      </div>
    </main>
